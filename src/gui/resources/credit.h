...
char credit_scroll_text[] = "                               Neocd/PS2 - PS2 specific code by Evilo - Ported from NeoCD/SDL by Foster - Original NeoCD(DOS) version by Martinez Fabrice             Thanks to : PS2DEV (www.ps2dev.org) all people that made this possible through toolchain & PS2SDK and for hosting NeoCD/PS2 sources, www.ps2-scene.org for hosting NeoCD/PS2 website & <G> , NeoCD/SDL team, Hiryu, Blackdroid, 7not6, Shazz, lkz, Pixel, Drakonite, Gawd, Boule, my gf, Linus Torvald  .....  and anybody else that I've missed out !            Visit: http://www.ps2dev.org & http://www.ps2-scene.org"; 
