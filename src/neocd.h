...
#include "video/video_util.h"
#include "input/input.h"

#include "unzip/unzip.h"
#include "unzip/zfile.h"
...
extern char 	path_prefix[256] __attribute__((aligned(64)));
...
typedef struct
{
	...
	int	machine_type;		// neocd / aes/mvs
